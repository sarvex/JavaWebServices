...
public class Predictions {
    ...
    public void setServletContext(ServletContext sctx) {                /** 1 **/
	this.sctx = sctx;
    }
	...
	String filename = "/WEB-INF/data/predictions.db";               /** 3 **/
	...
	try {
	    ...
	    XMLEncoder encoder = new XMLEncoder(out);                   /** 5 **/
	    encoder.writeObject(predictions); // serialize to XML       /** 6 **/
	    encoder.close();                                            /** 7 **/
	    xml = out.toString(); // stringify                          /** 8 **/
	}
	catch(Exception e) { }
	return xml;                                                     /** 9 **/
    }
